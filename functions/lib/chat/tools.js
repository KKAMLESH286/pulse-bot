...
exports.COACH_TOOLS = void 0;
exports.COACH_TOOLS = [
    {
        name: "get_workout_history",
        description: "Retrieve the user's workout history from Firestore. " +
    ...
    {
        name: "log_workout",
        description: "Save a structured workout to Firestore. " +
        ...
        input_schema: {
            ...
            properties: {
                date: {
                    type: "string",
                    description: "Workout date in YYYY-MM-DD format. Defaults to today if not specified.",
                },
                type: {
                    type: "string",
                    description: 'Workout type: "strength", "cardio", "flexibility", etc. Defaults to "strength".',
                },
                day: {
                    type: "string",
                    description: 'Optional training day label, e.g. "Push Day", "Leg Day", "Upper Body".',
                },
                exercises: {
                    type: "array",
                    items: {
    ...
    },
    {
        ...
        description: "Find workouts similar to a query using vector search. " +
        ...
        input_schema: {
            ...
            properties: {
                query: {
                    type: "string",
                    description: "Natural language description of the workout to search for. " +
                        "E.g. 'heavy bench press and triceps' or 'leg day with squats and lunges'.",
                },
                limit: {
                    type: "number",
                    description: "Maximum number of similar workouts to return. Defaults to 5.",
                },
            },
            required: ["query"],
        },
    },
    {
        ...
        description: "Analyze the user's recent workout history and suggest what they should do next. " +
        ...
        input_schema: {
            ...
            properties: {
                days_lookback: {
                    type: "number",
                    description: "How many days of history to consider. Defaults to 14.",
                },
            },
            required: [],
        },
    },
    {
        ...
        description: "Retrieve the list of exercises the user has ever performed, with their best stats. " +
        ...
        input_schema: {
            ...
            properties: {
                muscle_group: {
                    type: "string",
                    description: "Optional filter by muscle group keyword (e.g. 'chest', 'legs', 'back'). " +
    ...
    {
        name: "set_program",
        description: "Update the user's training program stored in agent_config/program. " +
        ...
        input_schema: {
            ...
            properties: {
                content: {
                    type: "string",
                    description: "The full training program content in markdown format. " +
